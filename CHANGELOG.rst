...
| This is the first ever release of the **ili2py** Python Package.
| The package is open source and is part of the **ili2py** Project.
| The project is hosted in a public repository on github at https://github.com/vvmruder/ili2py
...
- **CI Pipeline** running on Github Actions at https://github.com/vvmruder/ili2py/actions
