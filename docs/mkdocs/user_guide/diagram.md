...
This program generates diagrams from IMD16. The following section gives
an overview about what formats are supported and the limitations.

!!! info
    Be aware, this project is not meant to be used to create UML-Diagrams you can graphically edit later. It trys to
...
text file into the desired output. The aim is automation here too. We want to transform the understanding
...
![](../assets/img/plantuml_example.svg)

## PlantUML Role Members

This is a variant of the standard plantuml above. It tries to keep things clean by adding the information of roles and
their multiplicity in the frame of the class. Even if this is not pure UML anymore it improves readability on messy
and complex diagrams.

![](../assets/img/plantuml_role_members_example.svg)
