...
| id | Construct                | ili Kind       | Mandatory v1 | Reading IMD | Index Mapper | Python Classes | UML PlantUML | UML Mermaid | Code                                                                                                                                         | Comment                                              |
|----|--------------------------|----------------|:------------:|:-----------:|--------------|----------------|--------------|-------------|----------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|
...
| 4  | ModelData.MetaAttributes | ASSOCIATION    |      ✅       |      ✅      | ✅            | ✅              |              |             | [Link](/code/ilismeta16/#ili2py.interfaces.interlis.interlis_24.ilismeta16.model_data.abstract_element.MetaAttributeElement.MetaElement_ref) | Currently meta attributes on AttrOrParam are missing |
